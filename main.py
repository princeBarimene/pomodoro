...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        title_label.config(text="Break", font=(FONT_NAME,25,"bold"),fg=RED)

    elif reps % 2 == 0:
        countdown(short_break_sec)
        title_label.config(text="Break", font=(FONT_NAME,25,"bold"),fg=PINK)
    
    else:

        countdown(work_sec)
        title_label.config(text="Work", font=(FONT_NAME,25,"bold"),fg=GREEN)
...
check_mark_label = Label(fg = GREEN, font=(FONT_NAME,35,"bold"), bg=YELLOW)
